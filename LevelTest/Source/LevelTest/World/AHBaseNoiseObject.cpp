#include "AHBaseNoiseObject.h"
#include "Components/StaticMeshComponent.h"
#include "Kismet/GameplayStatics.h"
#include"Perception/AISense_Hearing.h"

// Sets default values
AAHBaseNoiseObject::AAHBaseNoiseObject()
{
	...
	MeshComp->OnComponentHit.AddDynamic(this, &AAHBaseNoiseObject::OnHit);
...
void AAHBaseNoiseObject::BeginPlay()
{
	Super::BeginPlay();
	
}

void AAHBaseNoiseObject::OnHit(UPrimitiveComponent* HitComp, AActor* OtherActor, UPrimitiveComponent* OtherComp, FVector NormalImpulse, const FHitResult& Hit)
{
