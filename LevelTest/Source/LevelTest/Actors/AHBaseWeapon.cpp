...
void AAHBaseWeapon::Fire(const FVector& ShootLocation, const FRotator& ShootingRotation)
{
...
void AAHBaseWeapon::BeginPlay()
{
	Super::BeginPlay();
	
}

void AAHBaseWeapon::SecondaryAction(bool bIsPressed)
{
    if (bIsPressed)
    {
...
void AAHBaseWeapon::Interact(AActor* Interactor)
{
    if (Interactor)
    {
...
void AAHBaseWeapon::PlayEmptySound()
{
    if (EmptySound)
    {
