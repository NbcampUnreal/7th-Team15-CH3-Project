#include "AHPhasePostProcess.h"
#include "Components/PostProcessComponent.h"
#include "Game/AHGameMode.h"
#include "Kismet/GameplayStatics.h"

AAHPhasePostProcess::AAHPhasePostProcess()
{
...
void AAHPhasePostProcess::BeginPlay()
{
	Super::BeginPlay();
	
	if (AAHGameMode* GM = Cast<AAHGameMode>(UGameplayStatics::GetGameMode(GetWorld())))
	{
		GM->OnGlobalPhaseChanged.AddUObject(this, &AAHPhasePostProcess::UpdatePostProcess);
	}
}


void AAHPhasePostProcess::UpdatePostProcess(int32 NewPhase)
{
...
void AAHPhasePostProcess::UpdateHealthVignette(float HPPercent)
{
